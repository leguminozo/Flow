...
const getMockShopifyProducts = (): AppProduct[] => [
  {
    ...
    description: 'Miel pura de ulmo, extraída de los bosques nativos del sur de Chile. Sabor único y propiedades medicinales excepcionales.',
  ...
  {
    id: 'mock-miel-multifloral',
    name: 'Miel Multifloral',
    description: 'Miel multifloral de temporada, con el sabor y aroma de múltiples flores silvestres. Perfecta para el consumo diario.',
    ...
    store: 'Obrera y Zángano',
    inStock: true,
    tags: ['miel', 'multifloral', 'natural', 'artesanal'],
    brand: 'Obrera y Zángano',
    size: '350g',
    shopifyData: {
      handle: 'miel-multifloral',
  ...
  {
    id: 'mock-jabon-miel-avena',
    name: 'Jabón de Miel y Avena',
    description: 'Jabón artesanal elaborado con miel pura y avena natural. Ideal para pieles sensibles y secas.',
    price: CurrencyService.roundToNearestTen(4990),
    image: 'https://images.pexels.com/photos/4465828/pexels-photo-4465828.jpeg?auto=compress&cs=tinysrgb&w=800',
    category: 'Cuidado Personal',
    origin: 'Shopify',
    store: 'Obrera y Zángano',
    inStock: true,
    tags: ['jabón', 'miel', 'avena', 'artesanal', 'natural'],
    brand: 'Obrera y Zángano',
    size: '120g',
    shopifyData: {
      handle: 'jabon-miel-avena',
  ...
  {
    id: 'mock-vela-cera-abeja',
    name: 'Vela de Cera de Abeja',
    description: 'Vela artesanal elaborada con cera de abeja 100% pura. Aroma natural y larga duración.',
    price: CurrencyService.roundToNearestTen(6990),
    image: 'https://images.pexels.com/photos/1123262/pexels-photo-1123262.jpeg?auto=compress&cs=tinysrgb&w=800',
    category: 'Otros',
    origin: 'Shopify',
    store: 'Obrera y Zángano',
    inStock: true,
    tags: ['vela', 'cera', 'abeja', 'artesanal', 'natural'],
    brand: 'Obrera y Zángano',
    size: 'Mediana',
    shopifyData: {
      handle: 'vela-cera-abeja',
